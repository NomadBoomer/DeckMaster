...
const BuildStepsCard: React.FC<BuildStepsCardProps> = ({ steps, deckContext }) => {
  ...
  const [openStep, setOpenStep] = useState<number | null>(1); // Default first step open
            ...
            return (
                <div key={step.stepNumber} className="bg-white">
                    <button 
                        ...
                        className={`w-full text-left p-4 flex items-center justify-between transition-colors ${isOpen ? 'bg-blue-50' : 'hover:bg-gray-50'}`}
                    >
                    ...
                    {isOpen && (
                        <div className="p-4 pl-16 pr-6 bg-blue-50/30 animate-fade-in-down">
                            ...
                            {images[step.stepNumber] ? (
                                ...
                                <button 
                                    ...
                                    className="text-sm bg-white border border-blue-200 text-blue-600 px-4 py-2 rounded-lg shadow-sm hover:bg-blue-50 font-medium disabled:opacity-50 flex items-center gap-2"
                                >
